...
func shoot():
	...
	b.start(position + Vector2(0, -8), Vector2(0, -250))
	bl.start(position + Vector2(0, -8), Vector2(-50, -250))
	br.start(position + Vector2(0, -8), Vector2(50, -250))
